 ...
 *  <li>Declare the WaittingBar in your class variable section. This may be done in your World or in the Actor.</li>
...
public class WaittingBar extends Actor
{
     ...
     *                  null instead.
     */
    public WaittingBar (int maxVal, Actor owner){
     ...
     */
    public WaittingBar (int maxVal, int currVal, Actor owner, int width, int height, int offset){
     ...
     */
    public WaittingBar (int maxVal,  int currVal, Actor owner, int width, int height, int offset, Color filledColor, Color missingColor){
     ...
     */
    public WaittingBar (int maxVal,  int currVal, Actor owner, int width, int height, int offset, Color filledColor, Color missingColor, boolean hideAtMax){
     ...
     */
    public WaittingBar (int maxVal,  int currVal, Actor owner, int width, int height, int offset, Color filledColor, Color missingColor, boolean hideAtMax, Color borderColor, int borderThickness){
     ...
     *  @param borderThickness  the thickness of the border. This value should be at least 1.
     */
    public WaittingBar (int maxVals[],  int currVals[], Actor owner, int width, int height, int offset, Color filledColor[], Color missingColor[], boolean hideAtMax, Color borderColor, int borderThickness){
